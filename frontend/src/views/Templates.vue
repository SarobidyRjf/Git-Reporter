...
async function saveTemplate() {
  ...
  try {
    ...
    showError(error.response?.data?.error?.message || error.response?.data?.message || error.message || 'Erreur lors de la sauvegarde');
  } finally {
...
async function deleteTemplate(template: any) {
  ...
  try {
    ...
    showError(error.response?.data?.error?.message || error.response?.data?.message || error.message || 'Erreur lors de la suppression');
  } finally {
